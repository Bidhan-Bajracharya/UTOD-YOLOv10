...
# === CONFIGURATION ===
DATASET_DIR = "/home/dsai-st125287/project/RUOD_YOLO"
LABELS_DIR = os.path.join(DATASET_DIR, "labels")
YAML_PATH = "/home/dsai-st125287/project/UTOD-YOLOv10/data/ruod.yaml"
...
if __name__ == "__main__":
    ...
    if bad_entries:
        ...
        model.train(
            ...
            name="ruod_dwcv2"            # Experiment name
        )
